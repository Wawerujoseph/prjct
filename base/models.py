...
class Part4(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    u_id_front = models.ImageField(null=True, blank=True) 
    u_id_back = models.ImageField(null=True, blank=True) 
    u_photo = models.ImageField(null=True, blank=True) 
    u_b_certificate = models.ImageField(null=True, blank=True) 
    u_m_certificate = models.ImageField(null=True, blank=True) 
    p_id_front = models.ImageField(null=True, blank=True) 
    p_id_back = models.ImageField(null=True, blank=True) 
    p_photo = models.ImageField(null=True, blank=True) 
    p_b_certificate = models.ImageField(null=True, blank=True) 
    r_id_front = models.ImageField(null=True, blank=True) 
    r_id_back = models.ImageField(null=True, blank=True) 
    r_photo = models.ImageField(null=True, blank=True) 
    createdAt = models.DateTimeField(auto_now_add=True)
